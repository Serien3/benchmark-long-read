...
```bash
Rscript scripts/phasing_ed_b_whatshap_ng50_depth/phasing_ed_b_whatshap_ng50_depth.R
```

Outputs are written under `figures/phasing_ed_b_whatshap_ng50_depth/` as editable
