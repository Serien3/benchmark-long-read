...
```bash
Rscript scripts/phasing_main_d_longphase_hamming_depth/phasing_main_d_longphase_hamming_depth.R
```

Outputs are written under `figures/phasing_main_d_longphase_hamming_depth/` as editable
