...
```bash
Rscript scripts/phasing_ed_e_whatshap_caller_sensitivity/phasing_ed_e_whatshap_caller_sensitivity.R
```

Outputs are written under `figures/phasing_ed_e_whatshap_caller_sensitivity/` as
