...
```bash
Rscript scripts/phasing_main_b_longphase_30x_profile/phasing_main_b_longphase_30x_profile.R
```

Outputs are written under `figures/phasing_main_b_longphase_30x_profile/` as editable
