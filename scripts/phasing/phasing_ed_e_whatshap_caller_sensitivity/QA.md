...
- **Source data:** `figures/phasing/phasing_ed_e_whatshap_caller_sensitivity/source_data_plotted.csv`.
- **Paired differences:** `figures/phasing/phasing_ed_e_whatshap_caller_sensitivity/paired_caller_differences.csv`.
- **Field mapping audit:** `figures/phasing/phasing_ed_e_whatshap_caller_sensitivity/clair3_field_crosscheck.csv`.
