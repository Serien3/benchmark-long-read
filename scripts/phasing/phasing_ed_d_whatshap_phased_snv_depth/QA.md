...
- **Source data:** `figures/phasing/phasing_ed_d_whatshap_phased_snv_depth/source_data_plotted.csv`.
- **Paired geometry data:** `figures/phasing/phasing_ed_d_whatshap_phased_snv_depth/paired_mapper_differences.csv`.
