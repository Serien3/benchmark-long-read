...
```bash
Rscript scripts/phasing/phasing_ed_c_whatshap_hamming_depth/phasing_ed_c_whatshap_hamming_depth.R
```

Outputs are written under `figures/phasing/phasing_ed_c_whatshap_hamming_depth/` as editable
