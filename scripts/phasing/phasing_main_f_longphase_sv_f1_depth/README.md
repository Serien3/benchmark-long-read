...
```bash
Rscript scripts/phasing/phasing_main_f_longphase_sv_f1_depth/phasing_main_f_longphase_sv_f1_depth.R
```

Outputs are written under `figures/phasing/phasing_main_f_longphase_sv_f1_depth/` as editable
