...
```bash
Rscript scripts/phasing/phasing_main_e_longphase_sv_phased_depth/phasing_main_e_longphase_sv_phased_depth.R
```

Outputs are written under `figures/phasing/phasing_main_e_longphase_sv_phased_depth/` as
