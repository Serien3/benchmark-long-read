...
```bash
Rscript scripts/phasing_main_c_longphase_ng50_depth/phasing_main_c_longphase_ng50_depth.R
```

Outputs are written under `figures/phasing_main_c_longphase_ng50_depth/` as editable
