...
```bash
Rscript scripts/phasing_ed_a_whatshap_30x_profile/phasing_ed_a_whatshap_30x_profile.R
```

Outputs are written under `figures/phasing_ed_a_whatshap_30x_profile/` as editable
